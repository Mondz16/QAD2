    ...
    <div id="successPopup" class="popup">
        <div class="popup-content">
            <?php if (isset($email_success) && $email_success): ?>
                ...
                <div class="popup-text">Schedule approved successfully.</div>
                <div style="height: 50px; width: 0px;"></div>
                <a class="okay" href="schedule_college.php?college=<?php echo urlencode($college_name); ?>&college_code=<?php echo urlencode($schedule_details['college_code']); ?>">OKAY</a>
            ...
            <?php elseif (isset($email_error) && $email_error): ?>
                ...
                <div style="height: 20px; width: 0px;"></div>
                <div class="popup-text"><?php echo $email_error; ?></div>
                <div style="height: 50px; width: 0px;"></div>
                <a class="okay" href="schedule_college.php?college=<?php echo urlencode($college_name); ?>&college_code=<?php echo urlencode($schedule_details['college_code']); ?>">OK</a>
                <div style="height: 100px; width: 0px;"></div>
                <div class="hairpop-up"></div>
            <?php else: ?>
                <div style="height: 50px; width: 0px;"></div>
                <img class="Success" src="images/Error.png" height="100">
                <div style="height: 20px; width: 0px;"></div>
                <div class="popup-text"><?php echo isset($error_message) ? $error_message : 'Unknown error.'; ?></div>
                <div style="height: 50px; width: 0px;"></div>
                <a class="okay" href="schedule_college.php?college=<?php echo urlencode($college_name); ?>&college_code=<?php echo urlencode($schedule_details['college_code']); ?>">OK</a>
                <div style="height: 100px; width: 0px;"></div>
                <div class="hairpop-up"></div>
