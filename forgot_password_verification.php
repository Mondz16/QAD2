...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_SESSION['otp']) && isset($_SESSION['otp_expiry']) && $entered_otp === $_SESSION['otp'] && time() <= $_SESSION['otp_expiry']) {
        // OTP is correct and not expired, proceed to reset the password
        $verified = true;
        $_SESSION['otp_verified'] = true; // Set a flag to indicate OTP is verified
...
<head>
    ...
    <script>
        ...
        function resendOTP() {
            ...
            xhttp.open("GET", "forgot_password_verification.php?resend=1", true);
            xhttp.send();
    ...
    <div class="container">
        <div class="body1">
            <div class="bodyLeft">
                ...
                <form method="post" action="forgot_password_verification.php">
