...
<body>
    <div class="wrapper">
        ...
        <h1>PENDING ORIENTATIONS</h1>
        <div class="row m-1 mt-3">
            <div class="col-12 border rounded-2" style="background: white;">
                <div class="row no-gutters py-2">
                    <div class="col-6">
                        <button id="collegesBtn" class="pobtn border btn w-100 py-2" onclick="showTable('collegeTable', 'collegesBtn')">ONLINE</button>
                    </div>
                    <div class="col-6">
                        <button id="sucBtn" class="nebtn border btn w-100 py-2" onclick="showTable('sucTable', 'sucBtn')">FACE TO FACE</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table id="collegeTable" class="table border rounded-2">
                    ...
                    <tbody>
                        <tr>
                            <td>01</td>
                            <td>2024-07-30</td>
                            <td>zoomlink/pogiboysmeetings</td>
                            <td>looksmaxxing</td>
                            <td>
                                <button class="btn btn-sm btn-edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
