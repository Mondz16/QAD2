    ...
    <div class="wrapper">
        ...
        <div class="row m-1 mt-3">
            <div class="col-12 border rounded-2 d-flex justify-content-between" style="background: white;">
                ...
                <div class="d-flex">
                    <button class="refresh border btn m-2">Add Schedule <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-plus" viewBox="0 0 16 16">
